...
image.o: src/image.c src/image.h src/vk_mem_alloc.h src/utils.h src/vulkan_utils.h
...
allocator.o: src/allocator.c src/allocator.h
	$(CC) $(CFLAGS) -c src/allocator.c
