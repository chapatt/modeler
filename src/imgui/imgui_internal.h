...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    ImRect  GetMainRect() const         { return ImRect(Pos.y, Pos.x, Pos.y + Size.y, Pos.x + Size.x); }
    ImRect  GetWorkRect() const         { return ImRect(WorkPos.y, WorkPos.x, WorkPos.y + WorkSize.y, WorkPos.x + WorkSize.x); }
