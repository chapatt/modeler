...
CIMGUI_API void ImGui_SetItemTooltipUnformatted(const char* text);                   // set a text-only tooltip if preceeding item was hovered. override any previous call to SetTooltip().
